...
def main():
    ...
    with st.sidebar:
        ...
        st.info(
            "Historical/yfinance ingestion is intentionally isolated from this "
            "Kotak LIVE environment. This app publishes Kotak LIVE raw data only."
        )
    ...
    if st.session_state.producer_running:
        st.success(
            "🟢 Raw Producer is active. Kotak raw quotes are being "
